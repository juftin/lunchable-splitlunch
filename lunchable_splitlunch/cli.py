...
def splitlunch_expenses(**kwargs: Union[int, str, bool]) -> None:
    ...
    """
    from lunchable_splitlunch.lunchmoney_splitwise import SplitLunch
...
def make_splitlunch_import(**kwargs: Union[int, str, bool]) -> None:
    ...
    re-categorized to `Reimbursement`. Any tags will be reapplied.
    """
    from lunchable_splitlunch.lunchmoney_splitwise import SplitLunch
...
def make_splitlunch_direct_import(**kwargs: Union[int, str, bool]) -> None:
    ...
    Send a transaction to Splitwise and then split the original
    transaction in Lunch Money. One of these new splits will be
    recategorized to `Reimbursement`. Any tags will be reapplied.
    """
    from lunchable_splitlunch.lunchmoney_splitwise import SplitLunch
